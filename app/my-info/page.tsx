...
const MI_CSS = `
.mi{ --ink:#23272a; --ink2:#333333; --mut:#6b7178; --faint:#9aa0a6; --line:#e6e6e9; --bg:#f4f4f5; --card:#ffffff;
...
.mi-input:focus{ border-color:var(--ink); background:#fff; box-shadow:0 0 0 3px rgba(35,39,42,.10); }
