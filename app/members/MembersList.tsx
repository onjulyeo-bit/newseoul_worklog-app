  ...
  return (
    <div className="moim-mem">
      ...
      <details className="grade-guide">
        ...
        <ul>
          <li><b>정회원</b> — 중앙회에 정회원으로 등록하고 연회비를 납부한 정식 회원</li>
          <li><b>부부정회원</b> — 정회원의 배우자가 중앙회 정회원 등록을 신청하여 배우자 등록비(20만 원)를 납부한 회원 (부부 동반 정회원)</li>
          <li><b>가족회원</b> — 정회원의 배우자 또는 가족으로, 회비 납부 의무가 면제되는 회원</li>
          <li><b>준회원</b> — 준회원 회비를 납부한 회원</li>
          <li><b>신입회원</b> — 당해 연도에 신규 가입한 회원</li>
          <li><b>명예회원</b> — 원로 예우 대상으로 회비가 면제되며, 입금분은 후원금으로 처리되는 회원</li>
          <li><b>유보회원</b> — 활동을 일시 중단하여 중앙회가 별도 관리하는 회원 (유보 기간 2년, 초과 시 신입회원으로 재등록)</li>
          <li><b>VIP</b> — 입회 의사로 지회 단체대화방에 참여하였으나, 중앙회 정회원 등록 및 준회원 회비 납부 이전 단계의 입회 예정 회원</li>
        </ul>
      </details>
          ...
          {!edit ? (
            <div className="dm-sections">
              ...
              <section className="dm-sec"><h3 className="dm-sec-t">연락·신앙</h3>
                <Field label={m.address_type ? `주소 (${m.address_type})` : "주소"} value={m.address} /><Field label="출석교회" value={m.home_church} /></section>
            ...
            <div className="dm-sections">
              ...
              <section className="dm-sec"><h3 className="dm-sec-t">연락·신앙</h3>
                <EditSelect label="주소 구분" value={m.address_type || ""} options={["집", "회사"]} onChange={(v) => set("address_type", v)} />
...
.moim-mem .b-blue{ background:#eaf2fd; color:#00559e; }
...
.moim-mem .stat-ic.t-blue{ background:#eaf2fd; color:#00559e; }
