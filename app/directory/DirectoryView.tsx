...
.moim-dir .cardbtn{ display:inline-flex; align-items:center; gap:6px; background:#f3f8fe; color:#0032a8; border:1px solid #d6e6fa; font-weight:700; font-size:14px; padding:9px 14px; border-radius:999px; text-decoration:none; white-space:nowrap; }
