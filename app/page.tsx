...
export default async function MemberListPage() {
  ...
  const { data: membersData } = await supabase
    .from("members")
    .select(
      "id, name, gender, phone, email, registration, grade, status, spouse_name, industry, company, position, vision_school, leadership_school, car_model, car_number, parking_registered, joined_on, tags, photo_url, intended_role, birth_date, birth_calendar, address, address_type, home_church, intro, business_card_url",
    )
    .eq("chapter_id", "새서울")
