...
const ETYPE: Record<TypeV, { Icon: React.ComponentType<{ size?: number }>; bg: string; accent: string }> = {
  ...
  심방: { Icon: HeartHandshake, bg: "linear-gradient(160deg,#eaf2fd,#dceafb)", accent: "#00559e" },
...
.moim-ev{
  ...
  --ink:#16181d; --ink-2:#3d424d; --ink-3:#767d8a; --line:#ecedf0; --bg:#ffffff; --bg-warm:#fafafb; --navy:#063d63;
