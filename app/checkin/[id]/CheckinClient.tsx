...
.moim-ck .b-blue{ background:#eaf2fd; color:#003ecc; }
...
.moim-ck .ck-nofee{ margin-top:18px; display:flex; align-items:center; justify-content:center; gap:8px; background:#eaf2fd; color:#003ecc; font-size:14.5px; font-weight:700; padding:15px; border-radius:14px; }
