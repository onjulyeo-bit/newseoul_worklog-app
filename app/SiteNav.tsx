...
export default function SiteNav({ role, email, isOwner = false }: { role: string | null; email?: string | null; isOwner?: boolean }) {
  ...
  if (pathname.startsWith("/checkin") || pathname.startsWith("/preview-landing") || pathname.startsWith("/my-info") || pathname.startsWith("/instructor-form") || pathname.startsWith("/s/") || pathname.startsWith("/sign-guide")) return null;
